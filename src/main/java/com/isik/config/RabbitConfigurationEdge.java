...
public class RabbitConfigurationEdge implements RabbitListenerConfigurer {
    ...
    public Queue outgoingQueue() {
        ...
        RabbitMqUtil.createShovel(props, appProperties, Constants.LIVE_QUEUE, Constants.EXCHANGE, true);
        return queue;
    }

    @Bean
    public Binding binding() {
        return BindingBuilder.bind(outgoingQueue()).to(topicExchange()).with(Constants.ROUTING_KEY);
    }
    ...
    public Queue deadLetterQueue() {
        ...
        RabbitMqUtil.createShovel(props, appProperties, queue.getName(),queue.getName(),false);
        return queue;
    }
}
